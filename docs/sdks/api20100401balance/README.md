...
async function run() {
  const result = await twilioSDK.api20100401Balance.fetchBalance({
    accountSid: "<id>",
  });
...
import { api20100401BalanceFetchBalance } from "twilio-sdk/funcs/api20100401BalanceFetchBalance.js";
...
async function run() {
  const res = await api20100401BalanceFetchBalance(twilioSDK, {
    accountSid: "<id>",
  });
...
**Promise\<[operations.FetchBalanceResponse](../../models/operations/fetchbalanceresponse.md)\>**
