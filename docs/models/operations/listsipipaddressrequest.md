...
```typescript
import { ListSipIpAddressRequest } from "twilio-sdk/models/operations";

let value: ListSipIpAddressRequest = {
  accountSid: "<id>",
...
| `ipAccessControlListSid`                                                                                   | *string*                                                                                                   | :heavy_check_mark:                                                                                         | The IpAccessControlList Sid that identifies the IpAddress resources to read.                               |
