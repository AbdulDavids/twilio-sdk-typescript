...
```typescript
import { ListSipAuthRegistrationsCredentialListMappingRequest } from "twilio-sdk/models/operations";

let value: ListSipAuthRegistrationsCredentialListMappingRequest = {
  accountSid: "<id>",
  domainSid: "<id>",
};
```
