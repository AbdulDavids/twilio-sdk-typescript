...
```typescript
import { ListSipCredentialListMappingRequest } from "twilio-sdk/models/operations";

let value: ListSipCredentialListMappingRequest = {
  accountSid: "<id>",
  domainSid: "<id>",
};
```
...
| `domainSid`                                                                                                | *string*                                                                                                   | :heavy_check_mark:                                                                                         | A 34 character string that uniquely identifies the SIP Domain that includes the resource to read.          |
