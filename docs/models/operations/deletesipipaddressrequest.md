...
```typescript
import { DeleteSipIpAddressRequest } from "twilio-sdk/models/operations";

let value: DeleteSipIpAddressRequest = {
  accountSid: "<id>",
...
| `ipAccessControlListSid`                                                                                   | *string*                                                                                                   | :heavy_check_mark:                                                                                         | The IpAccessControlList Sid that identifies the IpAddress resources to delete.                             |
