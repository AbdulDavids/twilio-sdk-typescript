...
import { UpdateSigningKeyServerList } from "../models/operations/updatesigningkey.js";
import { Result } from "../types/fp.js";

export async function api20100401SigningKeyUpdateSigningKey(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateSigningKeyServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.UpdateSigningKeyResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail(["4XX", "5XX"]),
