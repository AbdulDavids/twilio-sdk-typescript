...
export const UsageRecordLastMonthEnumCategory = {
  ...
  IvrVirtualAgentCustomVoices: "ivr-virtual-agent-custom-voices",
  IvrVirtualAgentGenai: "ivr-virtual-agent-genai",
  Lookups: "lookups",
...
export type UsageRecordLastMonthEnumCategory = ClosedEnum<
  typeof UsageRecordLastMonthEnumCategory
>;

/** @internal */
export const UsageRecordLastMonthEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordLastMonthEnumCategory
> = z.nativeEnum(UsageRecordLastMonthEnumCategory);

/** @internal */
export const UsageRecordLastMonthEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordLastMonthEnumCategory
 ...
 */
export namespace UsageRecordLastMonthEnumCategory$ {
  /** @deprecated use `UsageRecordLastMonthEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordLastMonthEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordLastMonthEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordLastMonthEnumCategory$outboundSchema;
}
