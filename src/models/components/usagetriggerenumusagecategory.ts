...
export const UsageTriggerEnumUsageCategory = {
...
export type UsageTriggerEnumUsageCategory = ClosedEnum<
  typeof UsageTriggerEnumUsageCategory
>;

/** @internal */
export const UsageTriggerEnumUsageCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageTriggerEnumUsageCategory
> = z.nativeEnum(UsageTriggerEnumUsageCategory);

/** @internal */
export const UsageTriggerEnumUsageCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageTriggerEnumUsageCategory
 ...
 */
export namespace UsageTriggerEnumUsageCategory$ {
  /** @deprecated use `UsageTriggerEnumUsageCategory$inboundSchema` instead. */
  export const inboundSchema = UsageTriggerEnumUsageCategory$inboundSchema;
  /** @deprecated use `UsageTriggerEnumUsageCategory$outboundSchema` instead. */
  export const outboundSchema = UsageTriggerEnumUsageCategory$outboundSchema;
}
