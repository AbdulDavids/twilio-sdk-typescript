...
export const UsageRecordEnumCategory = {
...
export type UsageRecordEnumCategory = ClosedEnum<
  typeof UsageRecordEnumCategory
>;

/** @internal */
export const UsageRecordEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordEnumCategory
> = z.nativeEnum(UsageRecordEnumCategory);

/** @internal */
export const UsageRecordEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordEnumCategory
 ...
 */
export namespace UsageRecordEnumCategory$ {
  /** @deprecated use `UsageRecordEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordEnumCategory$outboundSchema;
}
