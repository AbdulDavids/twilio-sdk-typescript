...
/** @internal */
export const ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$inboundSchema:
  z.ZodType<
  ...
  > = z.object({
    ...
    capabilities: z.nullable(z.lazy(() => Capabilities$inboundSchema))
      .optional(),
  }).transform((v) => {
    return remap$(v, {
...
/** @internal */
export type ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$Outbound =
  {
    ...
    beta?: boolean | null | undefined;
    capabilities?: Capabilities$Outbound | null | undefined;
  };

/** @internal */
export const ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$outboundSchema:
  z.ZodType<
    ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$Outbound,
    z.ZodTypeDef,
    ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal
  > = z.object({
    ...
    beta: z.nullable(z.boolean()).optional(),
    capabilities: z.nullable(z.lazy(() => Capabilities$outboundSchema))
      .optional(),
  }).transform((v) => {
    return remap$(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$ {
  /** @deprecated use `ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$inboundSchema` instead. */
  export const inboundSchema =
    ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$inboundSchema;
  /** @deprecated use `ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$outboundSchema` instead. */
  export const outboundSchema =
    ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$outboundSchema;
  /** @deprecated use `ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$Outbound` instead. */
  export type Outbound =
    ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$Outbound;
}

export function apiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalToJSON(
  apiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal:
    ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal,
): string {
...
export function apiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalFromJSON(
  jsonString: string,
): SafeParseResult<
  ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal,
  SDKValidationError
> {
  return safeParse(
    ...
    (x) =>
      ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal' from JSON`,
  );
}
