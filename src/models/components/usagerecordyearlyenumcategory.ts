...
export const UsageRecordYearlyEnumCategory = {
...
export type UsageRecordYearlyEnumCategory = ClosedEnum<
  typeof UsageRecordYearlyEnumCategory
>;

/** @internal */
export const UsageRecordYearlyEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordYearlyEnumCategory
> = z.nativeEnum(UsageRecordYearlyEnumCategory);

/** @internal */
export const UsageRecordYearlyEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordYearlyEnumCategory
 ...
 */
export namespace UsageRecordYearlyEnumCategory$ {
  /** @deprecated use `UsageRecordYearlyEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordYearlyEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordYearlyEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordYearlyEnumCategory$outboundSchema;
}
