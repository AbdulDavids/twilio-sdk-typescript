...
export const UsageRecordDailyEnumCategory = {
...
export type UsageRecordDailyEnumCategory = ClosedEnum<
  typeof UsageRecordDailyEnumCategory
>;

/** @internal */
export const UsageRecordDailyEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordDailyEnumCategory
> = z.nativeEnum(UsageRecordDailyEnumCategory);

/** @internal */
export const UsageRecordDailyEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordDailyEnumCategory
 ...
 */
export namespace UsageRecordDailyEnumCategory$ {
  /** @deprecated use `UsageRecordDailyEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordDailyEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordDailyEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordDailyEnumCategory$outboundSchema;
}
