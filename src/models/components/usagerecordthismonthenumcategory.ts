...
export const UsageRecordThisMonthEnumCategory = {
...
export type UsageRecordThisMonthEnumCategory = ClosedEnum<
  typeof UsageRecordThisMonthEnumCategory
>;

/** @internal */
export const UsageRecordThisMonthEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordThisMonthEnumCategory
> = z.nativeEnum(UsageRecordThisMonthEnumCategory);

/** @internal */
export const UsageRecordThisMonthEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordThisMonthEnumCategory
 ...
 */
export namespace UsageRecordThisMonthEnumCategory$ {
  /** @deprecated use `UsageRecordThisMonthEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordThisMonthEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordThisMonthEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordThisMonthEnumCategory$outboundSchema;
}
