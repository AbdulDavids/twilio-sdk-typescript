...
export const UsageRecordMonthlyEnumCategory = {
...
export type UsageRecordMonthlyEnumCategory = ClosedEnum<
  typeof UsageRecordMonthlyEnumCategory
>;

/** @internal */
export const UsageRecordMonthlyEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordMonthlyEnumCategory
> = z.nativeEnum(UsageRecordMonthlyEnumCategory);

/** @internal */
export const UsageRecordMonthlyEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordMonthlyEnumCategory
 ...
 */
export namespace UsageRecordMonthlyEnumCategory$ {
  /** @deprecated use `UsageRecordMonthlyEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordMonthlyEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordMonthlyEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordMonthlyEnumCategory$outboundSchema;
}
