...
export const UsageRecordYesterdayEnumCategory = {
...
export type UsageRecordYesterdayEnumCategory = ClosedEnum<
  typeof UsageRecordYesterdayEnumCategory
>;

/** @internal */
export const UsageRecordYesterdayEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordYesterdayEnumCategory
> = z.nativeEnum(UsageRecordYesterdayEnumCategory);

/** @internal */
export const UsageRecordYesterdayEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordYesterdayEnumCategory
 ...
 */
export namespace UsageRecordYesterdayEnumCategory$ {
  /** @deprecated use `UsageRecordYesterdayEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordYesterdayEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordYesterdayEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordYesterdayEnumCategory$outboundSchema;
}
