 ...
 */
export const ApiV2010AccountNotificationInstanceRequestMethod = {
  Get: "GET",
  Post: "POST",
} as const;
/**
 * The HTTP method used to generate the notification. If the notification was generated during a phone call, this is the HTTP Method used to request the resource on your server. If the notification was generated by your use of our REST API, this is the HTTP method used to call the resource on our servers.
 */
export type ApiV2010AccountNotificationInstanceRequestMethod = ClosedEnum<
  typeof ApiV2010AccountNotificationInstanceRequestMethod
>;
...
/** @internal */
export const ApiV2010AccountNotificationInstanceRequestMethod$inboundSchema:
  z.ZodNativeEnum<typeof ApiV2010AccountNotificationInstanceRequestMethod> = z
    .nativeEnum(ApiV2010AccountNotificationInstanceRequestMethod);

/** @internal */
export const ApiV2010AccountNotificationInstanceRequestMethod$outboundSchema:
  z.ZodNativeEnum<typeof ApiV2010AccountNotificationInstanceRequestMethod> =
    ApiV2010AccountNotificationInstanceRequestMethod$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ApiV2010AccountNotificationInstanceRequestMethod$ {
  /** @deprecated use `ApiV2010AccountNotificationInstanceRequestMethod$inboundSchema` instead. */
  export const inboundSchema =
    ApiV2010AccountNotificationInstanceRequestMethod$inboundSchema;
  /** @deprecated use `ApiV2010AccountNotificationInstanceRequestMethod$outboundSchema` instead. */
  export const outboundSchema =
    ApiV2010AccountNotificationInstanceRequestMethod$outboundSchema;
}

/** @internal */
export const ApiV2010AccountNotificationInstance$inboundSchema: z.ZodType<
...
/** @internal */
export type ApiV2010AccountNotificationInstance$Outbound = {
...
/** @internal */
export const ApiV2010AccountNotificationInstance$outboundSchema: z.ZodType<
  ApiV2010AccountNotificationInstance$Outbound,
  z.ZodTypeDef,
  ApiV2010AccountNotificationInstance
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ApiV2010AccountNotificationInstance$ {
  /** @deprecated use `ApiV2010AccountNotificationInstance$inboundSchema` instead. */
  export const inboundSchema =
    ApiV2010AccountNotificationInstance$inboundSchema;
  /** @deprecated use `ApiV2010AccountNotificationInstance$outboundSchema` instead. */
  export const outboundSchema =
    ApiV2010AccountNotificationInstance$outboundSchema;
  /** @deprecated use `ApiV2010AccountNotificationInstance$Outbound` instead. */
  export type Outbound = ApiV2010AccountNotificationInstance$Outbound;
}

export function apiV2010AccountNotificationInstanceToJSON(
  apiV2010AccountNotificationInstance: ApiV2010AccountNotificationInstance,
): string {
  return JSON.stringify(
    ApiV2010AccountNotificationInstance$outboundSchema.parse(
      apiV2010AccountNotificationInstance,
    ),
  );
}

export function apiV2010AccountNotificationInstanceFromJSON(
  jsonString: string,
): SafeParseResult<ApiV2010AccountNotificationInstance, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ApiV2010AccountNotificationInstance$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ApiV2010AccountNotificationInstance' from JSON`,
  );
}
