...
export const UsageRecordAllTimeEnumCategory = {
...
export type UsageRecordAllTimeEnumCategory = ClosedEnum<
  typeof UsageRecordAllTimeEnumCategory
>;

/** @internal */
export const UsageRecordAllTimeEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordAllTimeEnumCategory
> = z.nativeEnum(UsageRecordAllTimeEnumCategory);

/** @internal */
export const UsageRecordAllTimeEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordAllTimeEnumCategory
 ...
 */
export namespace UsageRecordAllTimeEnumCategory$ {
  /** @deprecated use `UsageRecordAllTimeEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordAllTimeEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordAllTimeEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordAllTimeEnumCategory$outboundSchema;
}
