...
export const UsageRecordTodayEnumCategory = {
...
export type UsageRecordTodayEnumCategory = ClosedEnum<
  typeof UsageRecordTodayEnumCategory
>;

/** @internal */
export const UsageRecordTodayEnumCategory$inboundSchema: z.ZodNativeEnum<
  typeof UsageRecordTodayEnumCategory
> = z.nativeEnum(UsageRecordTodayEnumCategory);

/** @internal */
export const UsageRecordTodayEnumCategory$outboundSchema: z.ZodNativeEnum<
  typeof UsageRecordTodayEnumCategory
 ...
 */
export namespace UsageRecordTodayEnumCategory$ {
  /** @deprecated use `UsageRecordTodayEnumCategory$inboundSchema` instead. */
  export const inboundSchema = UsageRecordTodayEnumCategory$inboundSchema;
  /** @deprecated use `UsageRecordTodayEnumCategory$outboundSchema` instead. */
  export const outboundSchema = UsageRecordTodayEnumCategory$outboundSchema;
}
