 ...
 */
export const CreateStreamStatusCallbackMethod = {
  Get: "GET",
  Post: "POST",
} as const;
/**
 * The HTTP method Twilio uses when sending `status_callback` requests. Possible values are `GET` and `POST`. Default is `POST`.
 */
export type CreateStreamStatusCallbackMethod = ClosedEnum<
  typeof CreateStreamStatusCallbackMethod
>;

export type CreateStreamCreateStreamRequest = {
  /**
  ...
  track?: components.StreamEnumTrack | undefined;
  /**
   ...
   * The HTTP method Twilio uses when sending `status_callback` requests. Possible values are `GET` and `POST`. Default is `POST`.
   */
  statusCallbackMethod?: CreateStreamStatusCallbackMethod | undefined;
  /**
   * Parameter name
   */
...
export type CreateStreamRequest = {
   ...
   */
  callSid: string;
  requestBody?: CreateStreamCreateStreamRequest | undefined;
};
...
/** @internal */
export const CreateStreamStatusCallbackMethod$inboundSchema: z.ZodNativeEnum<
  typeof CreateStreamStatusCallbackMethod
> = z.nativeEnum(CreateStreamStatusCallbackMethod);

/** @internal */
export const CreateStreamStatusCallbackMethod$outboundSchema: z.ZodNativeEnum<
  typeof CreateStreamStatusCallbackMethod
> = CreateStreamStatusCallbackMethod$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreateStreamStatusCallbackMethod$ {
  /** @deprecated use `CreateStreamStatusCallbackMethod$inboundSchema` instead. */
  export const inboundSchema = CreateStreamStatusCallbackMethod$inboundSchema;
  /** @deprecated use `CreateStreamStatusCallbackMethod$outboundSchema` instead. */
  export const outboundSchema = CreateStreamStatusCallbackMethod$outboundSchema;
}

/** @internal */
export const CreateStreamCreateStreamRequest$inboundSchema: z.ZodType<
  CreateStreamCreateStreamRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
  Url: z.string(),
  Name: z.string().optional(),
  Track: components.StreamEnumTrack$inboundSchema.optional(),
  StatusCallback: z.string().optional(),
  StatusCallbackMethod: CreateStreamStatusCallbackMethod$inboundSchema
    .optional(),
...
/** @internal */
export type CreateStreamCreateStreamRequest$Outbound = {
  Url: string;
  Name?: string | undefined;
...
/** @internal */
export const CreateStreamCreateStreamRequest$outboundSchema: z.ZodType<
  CreateStreamCreateStreamRequest$Outbound,
  z.ZodTypeDef,
  CreateStreamCreateStreamRequest
> = z.object({
  url: z.string(),
  name: z.string().optional(),
  track: components.StreamEnumTrack$outboundSchema.optional(),
  statusCallback: z.string().optional(),
  statusCallbackMethod: CreateStreamStatusCallbackMethod$outboundSchema
    .optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreateStreamCreateStreamRequest$ {
  /** @deprecated use `CreateStreamCreateStreamRequest$inboundSchema` instead. */
  export const inboundSchema = CreateStreamCreateStreamRequest$inboundSchema;
  /** @deprecated use `CreateStreamCreateStreamRequest$outboundSchema` instead. */
  export const outboundSchema = CreateStreamCreateStreamRequest$outboundSchema;
  /** @deprecated use `CreateStreamCreateStreamRequest$Outbound` instead. */
  export type Outbound = CreateStreamCreateStreamRequest$Outbound;
}

export function createStreamCreateStreamRequestToJSON(
  createStreamCreateStreamRequest: CreateStreamCreateStreamRequest,
): string {
  return JSON.stringify(
    CreateStreamCreateStreamRequest$outboundSchema.parse(
      createStreamCreateStreamRequest,
    ),
  );
}

export function createStreamCreateStreamRequestFromJSON(
  jsonString: string,
): SafeParseResult<CreateStreamCreateStreamRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateStreamCreateStreamRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateStreamCreateStreamRequest' from JSON`,
  );
}
...
> = z.object({
  AccountSid: z.string(),
  CallSid: z.string(),
  RequestBody: z.lazy(() => CreateStreamCreateStreamRequest$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
export type CreateStreamRequest$Outbound = {
  AccountSid: string;
  CallSid: string;
  RequestBody?: CreateStreamCreateStreamRequest$Outbound | undefined;
};
...
> = z.object({
  accountSid: z.string(),
  callSid: z.string(),
  requestBody: z.lazy(() => CreateStreamCreateStreamRequest$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    accountSid: "AccountSid",
